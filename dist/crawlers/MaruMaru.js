...
var MaruMaruCrawler = (function (_super) {
    __extends(MaruMaruCrawler, _super);
    function MaruMaruCrawler() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.published = false;
        return _this;
    }
    MaruMaruCrawler.prototype.html = function () {
    ...
    MaruMaruCrawler.prototype.newChapter = function (html) {
        if (html == null) {
            return null;
        }
        ...
        var match = data[0].match(/https?:\/\/wasabisyrup.com\/archives\/[^"]*/g);
        var link = match[0];
        return link;
    };
    MaruMaruCrawler.prototype.fn = function () {
        return __awaiter(this, void 0, void 0, function () {
            var HTMLContent, link, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.published) {
                    ...
                    case 1:
                        HTMLContent = _a.sent();
                        link = this.newChapter(HTMLContent);
                        if (link == null) {
                            return [2, []];
                        }
                        this.published = true;
